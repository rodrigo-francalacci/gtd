  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <textarea
        ...
        spellCheck
        className="min-h-0 flex-1 resize-none border-none bg-paper px-3 py-2 text-[13px] leading-relaxed text-grey-900 placeholder:text-grey-500 focus:outline-none"
      />
    </div>
  );
}
